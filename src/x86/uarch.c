...
struct uarch* get_uarch_from_cpuid_intel(uint32_t ef, uint32_t f, uint32_t em, uint32_t m, int s) {
  ...
  CHECK_UARCH(arch, 0,  5,  0,  7, NA, "P54C (MMX)",        UARCH_P5_MMX,          350)
...
struct uarch* get_uarch_from_cpuid_centaur(uint32_t ef, uint32_t f, uint32_t em, uint32_t m, int s) {
  ...
  CHECK_UARCH(arch,  0,  6,  1,  9,   8, "Isaiah (CNS)",     UARCH_ISAIAH,       UNK)
  CHECK_UARCH(arch,  0,  6,  1, 10,   8, "Isaiah (CNS)",     UARCH_ISAIAH,       UNK)
  CHECK_UARCH(arch,  0,  6,  1, 11,   8, "Isaiah (CNS)",     UARCH_ISAIAH,       UNK)
  CHECK_UARCH(arch,  0,  6,  1, 12,   8, "Isaiah (CNS)",     UARCH_ISAIAH,       UNK)
