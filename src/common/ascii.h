...
asciiL logo_via         = { ASCII_VIA,         74, 15, false, {C_FG_CYAN},                                    {C_FG_WHITE,   C_FG_B_CYAN}  };
asciiL logo_rise        = { ASCII_RISE,        89, 20, false, {C_FG_GREEN, C_FG_B_WHITE, C_FG_WHITE, C_FG_B_GREEN}, {C_FG_WHITE, C_FG_B_GREEN}};
